...
const CompanionForm = () => {
  ...
  const onSubmit=async(values: z.infer<typeof formSchema>)=>{
      ...
      {
         console.log("Failed to submit and create companion");
         redirect("/");
      }
  }
  ...
  return (
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        render={({field}) => (
            ...
            <FormControl>
                <Textarea placeholder="Ex:- Fundamentals of C Programming" {...field} />
            </FormControl>
            <FormMessage />
            </FormItem>
          )}
       ...
       <FormField
        ...
        render={({field}) => (
            <FormItem>
            <FormLabel>Estimated duration in minutes for session</FormLabel>
            <FormControl>
